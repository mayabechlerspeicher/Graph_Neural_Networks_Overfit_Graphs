...
CUDA_VERSION=${1:-cu101}

# create virtual environment and activate it
conda create --name comparison python=3.7 -y
...
pip install torch-sc
atter==latest+${CUDA_VERSION} -f https://pytorch-geometric.com/whl/torch-${PYTORCH_VERSION}.html
